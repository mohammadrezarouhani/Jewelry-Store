<template>
  ...
  >
    <div class="bg-gray-900 flex w-full flex-wrap items-center justify-between px-3">
      ...
      >
        <ul
          class="w-full mr-auto flex flex-col lg:flex-row text-[1rem]"
        ...
        >
          ...
          <li class="mb-4 lg:mb-0 lg:pr-2 text-[1.2rem] text-amber-400" data-te-nav-item-ref>
            <a
              class="block transition duration-150 ease-in-out hover:text-neutral-700 focus:text-neutral-700 disabled:text-black/30 dark:hover:text-white dark:focus:text-white lg:p-2 [&.active]:text-black/90"
              href="#!"
              data-te-nav-link-ref
